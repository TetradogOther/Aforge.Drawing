...
namespace AForge.Imaging
{
    ...
    public class UnmanagedImage : IDisposable
    {
        ...
        public UnmanagedImage(Bitmap bmp) : this(bmp.LockBits(new Rectangle(new Point(),bmp.Size),ImageLockMode.ReadWrite,bmp.PixelFormat),EsArgb(bmp)) { }
        /// <summary>
        ...
        private static bool EsArgb(Bitmap dstImage)
        {
            bool isArgb = false;
