...
namespace AForge.Math.Geometry
{
    ...
    public sealed class Line
    {
        ...
        private Line( Point point, float theta )
        {
            ...
            k = (float) ( -1.0f / System.Math.Tan( theta ) );
        ...
        public float GetAngleBetweenLines( Line secondLine )
        {
            ...
            if ( ( !isVertical1 ) && ( !isVertical2 ) )
            {
                ...
                angle = (float) System.Math.Atan( tanPhi );
            }
            else
            {
                ...
                if ( isVertical1 )
                {
                    angle = (float) ( System.Math.PI / 2 - System.Math.Atan( k2 ) * System.Math.Sign( k2 ) );
                }
                else
                {
                    angle = (float) ( System.Math.PI / 2 - System.Math.Atan( k ) * System.Math.Sign( k ) );
                }
            }
        ...
        public float DistanceToPoint( Point point )
        {
            ...
            if ( !IsVertical )
            {
                ...
                distance = System.Math.Abs( ( k * point.X + b - point.Y ) / div );
            }
            else
            {
                distance = System.Math.Abs( b - point.X );
            }
