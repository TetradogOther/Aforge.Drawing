...
namespace AForge.Math.Geometry
{
    ...
    /// The idea of the implemented System.Math and algorithm is described in "Iterative Pose Estimation using
    ...
    public class CoplanarPosit
    {
        ...
        /// which are valid from the algorithm's System.Math point of view. For each pose an error is calculated,
